<?php
	...
	if(isset($_POST['bsimpan']))
	{
		...
		else
		{
			...
			$simpan = mysqli_query($koneksi, "INSERT INTO tmhs (nim, namamhs, jk, alamat, kota, email)
										  VALUES ('$_POST[tnim]', 
										  		 '$_POST[tnama]',
                                                 '$_POST[tjk]',  
										  		 '$_POST[talamat]',
...
<html>
<head>
	<title>CRUD 2020 PHP & MySQL + Bootstrap</title>
...
<div class="container">
	...
	<h2 class="text-center">By Mochammad Rafi Diaz Ardhana</h2>
	...
	<div class="card mt-3">
	  ...
	  <div class="card-body">
	    <form method="post" action="">
			...
			<div class="form-group">
	    		<label>Kota</label>
	    		<input type="text" class="form-control" name="tkota"  placeholder="Input Alamat anda disini!"><?=@$vkota?></input>
	    	</div>
			<div class="form-group">
	    		<label>Email</label>
	    		<input type="text" class="form-control" name="temail"  placeholder="Input Alamat anda disini!"><?=@$vemail?></input>
	    	</div>
			<div class="form-group">
                <label for="foto" >Foto</label>
                <div class="">
                    <input type="file" class="form-control" id="foto" name="tfoto" value="<?php echo $foto ?>">
                </div>
            </div>
